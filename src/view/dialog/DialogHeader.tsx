    ...
    return (
        <Suspense fallback={<HeaderFallback />}>
            <Await resolve={requiredData}>
                <div className="flex flex-col gap-x-4 border-b border-solid border-ax-border-neutral-subtle bg-[var(--ax-bg-default)] py-1">
...
const HeaderFallback = () => {
    ...
    return (
        <div className="flex flex-col gap-x-4 border-b border-ax-border-neutral-subtle bg-[var(--ax-bg-default)] py-1">
            <section aria-label="Dialog header">
                <div className="flex flex-row gap-x-2 pl-4">
                    <TilbakeKnapp className="md:hidden" />
