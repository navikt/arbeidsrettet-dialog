    ...
    return (
        <LinkPanel
            className={classNames(
                'my-1 max-w-full flex py-0 p-2 flex-row rounded-md border-ax-border-neutral-subtle hover:border-ax-border-neutral-strong !gap-0 border transition-colors duration-100 ease-in-out',
